...
function [a,v,logIKGmax] = SGA_ave_bat_UV(pra,V,Vidx,Cov_Noise_Inv,Cov_Noise_Inv_y_mu,X,x0,x_indep_mu,x_indep_Cov_X_V,varPra,var_X,var_Cov_Inv_y_M)
...
for k = 1:K
    ...
    for i = 1:M
        g_x = h_c_partial_x_X_UV(V,Vidx,theta,tau2,Cov_Noise_Inv,v_MB,i,x0(:,i),x_indep_mu_MB,x_indep_Cov_X_V_MB,cost_type,varPra,var_X,var_Cov_Inv_y_M); % averaged gradient over v_MB on x0(:,i)
...
for i = 1:M        
    neg_logIKG(i) = neg_logIKG_i_x_UV(V,Vidx,theta,tau2,Cov_Noise_Inv,X,i,x0_stop(:,i),x_indep_mu,x_indep_Cov_X_V,cost_type,varPra,var_X,var_Cov_Inv_y_M);
end
