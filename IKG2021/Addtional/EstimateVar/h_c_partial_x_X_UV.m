...
[noise_var_i_x, noise_var_d] = noise_var_est(i,x,varPra,var_X,var_Cov_Inv_y_M); 
...
if d_c_x == 0
    ...
    neg_logIKG = neg_logIKG_i_x_UV(V,Vidx,theta,tau2,Cov_Noise_Inv,X,i,x,x_indep_mu,x_indep_Cov_X_V,cost_type);
    h2c = exp(-neg_logIKG);
