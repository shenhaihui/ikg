function regret_plot = IKGwRC(density_type,cost_type,parpool_n,d,C)
...
[a,v,logIKGmax] = NoSGA(IKG_pra,V,Vidx,Cov_Noise_Inv,X,v0n,x_indep_mu,[]);
...
while consumption <= C
    ...
    v0n = v0_pool(:,:,n);
    % decide the sample location using IKG
    [a,v,logIKGmax] = NoSGA(IKG_pra,V,Vidx,Cov_Noise_Inv,X,v0n,x_indep_mu,x_indep_Cov_X_V);
...
% save data
save(['IKGwRC_' num2str(d) 'D_density' num2str(density_type) '_cost' num2str(cost_type) '.mat'],'regret_cost_L','regret_plot');