function [neg_logIKG, neg_d_logIKG] = neg_logIKG_i_x(V,Vidx,theta,tau2,Cov_Noise_Inv,X,i,x,x_indep_mu,x_indep_Cov_X_V,cost_type)
...
if idx == 0
    ...
    lam = sqrt(k_i_n_x_x + noise_var(i,x));
